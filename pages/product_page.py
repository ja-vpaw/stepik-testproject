...
class ProductPage(BasePage):
    ...
    def should_be_message_success_add_to_basket(self):
        ...
        message_add_to_basket = self.browser.find_element(*ProductPageLocators.MESSAGE_ADD_TO_BASKET_PRODUCT_NAME).text
    ...
    def should_not_be_message_success_add_to_basket(self):
        assert self.is_not_element_present(*ProductPageLocators.MESSAGE_ADD_TO_BASKET), "Add to basket message is presented"


    def should_disappear_message_success_add_to_basket(self):
        assert self.is_disappeared(*ProductPageLocators.MESSAGE_ADD_TO_BASKET), "Add to basket message is not disappeared"
